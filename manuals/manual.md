...
To get there you need to carefully plan and execute your travel through the galaxy.
...
The first Commander to clear their Quest Pile wins the game.
...
3. **Deal the Quest Piles:** From the Play Deck, deal face down Journey Cards to each Commander depending on the amount of Commanders:
   ...
   Flip the top card face up. That is each Commander's first Quest.
...
- All Journey Piles are public and can be built upon by the current Active Commander.
- Commanders may only play the next numbered card in the sequence within a Journey Pile. (The sequence is: Wormhole (0) -> Planets (1-10) -> Final Frontier (11))
...
- Played cards can come from the Commander's hand, Star Map lanes, or Quest Pile.
...
1. **Place cards in the Hyperspace Area:**
   - The Active Commander can place cards from 3 different sources:
     - **Commander's Hand**: If the Active Commander doesn't have cards in its hand, it must Refill from the Card deck back to the defined Commander Hand size (7 cards for 2-6 Commanders, 6 cards for 7-8 Commanders).
     - **Quest pile**: Only the top card of the pile can be played. Once the top card is played, flip the next card face up. The Active Commander can place more than one Quest card in the same turn as long as they are part of a valid ladder sequence.
     - **Star Map lanes:** Only the top card of each stack can be played. If a card is under another card in a lane, the card that is covering must be removed first in order to free the card underneath. Star Map cards cannot be moved between lanes. They can only be played in the Play Area.
   ...
   - If the Active Commander runs out of cards, it must immediately refill their hand from the Play Deck up to the defined Commander Hand size (7 cards for 2-6 Commanders, 6 cards for 7-8 Commanders). After refilling, it can continue placing cards in the Hyperspace Area as normal.
...
2. **Place card in Star Map lane:**
   ...
   - Once a card is placed in a Star Map lane, its position is permanent. It can only be removed by playing it into a Journey Pile.
...
**Discard**: To use this ability, place the Commander Card in the Discard Pile. These abilities are stronger and have effects that go beyond an specific Journey Pile. The Commander Card is trapped in the Discard Pile until the Play Deck is finished and the Discard Pile is reshuffled. When that happens, the Commander Card is freed and goes back to the Commander who owned it.

- Commander Cards remain trapped until their respective pile is completed or reshuffled. Commanders must adapt their strategy accordingly.
...
**Diplomatic Mission**: The Active Commander chooses another Commander, it gives 3 cards from its hand to that Commander. Then, take 3 random cards from its hand. If the Active Commander has less than 3 cards in its hand, this ability cannot be used.
...
**Cargo Bay**: At the end of the current turn, the Active Commander places all remaining hand cards in the Star Map. The Commander can choose in which order it places them as long as it doesn't change the position of the cards that were in the Star Map from before.
